...
public class FoodDao {
	...
	public List<Food> getFoodByPortions(int portions) {
		String sql = "SELECT food.food_code,food.display_name, COUNT(DISTINCT portion.portion_id) AS CNT FROM food , `portion` WHERE food.food_code=portion.food_code GROUP BY food.food_code HAVING CNT=? ORDER BY food.display_name ASC";
